      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          ...
          <div class="col-lg-6 col-5 text-right">
            <a href="<?php echo base_url(); ?>selfControl" class="tambah_self_control btn btn-sm btn-neutral">Kembali</a>
          </div>
        </div>
        <!-- Card stats -->
        <div class="row">
  ...
  <div class="container-fluid mt--6 shadow-sm">
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <button type="button" id="simpan_self_control" class="btn btn-sm btn-primary">Simpan</button>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form>
              <h6 class="heading-small text-muted mb-4">Self Control</h6>
              <div class="pl-lg-4">
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      <label class="form-control-label" for="metode">Metode</label>
                      <input type="text" id="metode" name="metode" class="form-control" placeholder="metode">
                    </div>
                  </div>
    ...
    <!-- Modal Create User -->
    <div class="modal fade" id="modal_tambah_self_control" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <script>
      $(document).ready(function() {
        ...
        // Edit Pegawai
        $('#simpan_self_control').on('click', function() {
          ...
          if (metode == '' || jenis == '' || urutan == '' || urutan == '0' || description == '' || status == '') {
            ...
            $.ajax({
              url: '<?php echo base_url(); ?>administrator/simpanselfcontrol',
              method: 'POST',
              data: {
                metode: metode,
                jenis: jenis,
              ...
              success: function(data) {
                ...
                window.location.href = "<?php base_url(); ?>selfcontrol/";
              }
            });
          }
