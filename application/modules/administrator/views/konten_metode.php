  ...
  <div class="container-fluid mt--6 shadow-sm">
      ...
      <!-- Modal Create User -->
      <div class="modal fade" id="modal_konten_metode" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <form method="post" id="form_konten_metode">
                      <div class="modal-body">
                          ...
                          <div class="form-group">
                              <input type="hidden" name="id_metode" id="id_metode" value="<?php echo $id_metode ?>">
      ...
      <script>
          $(document).ready(function() {
              ...
              var dataTable = $('#tabel_konten_target').DataTable({
                  ...
                  "order": [],
                  "ajax": {
                      "url": "<?php echo base_url(); ?>administrator/tabellistselfcontrol",
                      "type": "POST",
                      "data": function(data) {
              ...
              $('#tambah_konten_metode').on('click', function() {
                  ...
                  $('#modal_konten_metode').modal('show');
                  $('.modal-title').text('Tambah File');
              });

              //submit konten
              $(document).on('submit', '#form_konten_metode', function(event) {
                  ...
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          $.ajax({
                              url: '<?php echo base_url(); ?>administrator/simpanlistselfcontrol',
                              method: 'POST',
                              ...
                              success: function(data) {
                                  ...
                                  $('#modal_konten_metode').modal('hide');
                                  $('#form_konten_metode')[0].reset();
                              }
                          });
                      }
                  })
