          ...
          <div class="header-body">
              <div class="row align-items-center py-4">
                  ...
                  <div class="col-lg-6 col-5 text-right">
                      <a href="<?php echo base_url(); ?>administrator/tambahkuesioner" class="tambah_edukasi btn btn-sm btn-neutral">Tambah</a>
                  </div>
              </div>
              <!-- Card stats -->
              <div class="row">
      ...
      <script>
          $(document).ready(function() {
              ...
              var dataTable = $('#tabel_kuesioner').DataTable({
                  ...
                  "order": [],
                  "ajax": {
                      "url": "<?php echo base_url(); ?>administrator/tabelkuesioner",
                      "type": "POST",
                  },
                  columnDefs: [{
                      orderable: false,
              ...
              $(document).on('click', '.kuesioner', function() {
                  var id = $(this).attr('id');
                  window.open('<?= base_url(); ?>administrator/kontenkuesioner/' + id);
              });
