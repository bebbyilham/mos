          ...
          <div class="header-body">
              <div class="row align-items-center py-4">
                  ...
                  <div class="col-lg-6 col-5 text-right">
                      <button type="button" id="tambah_pertanyaan_kuesioner" class="btn btn-sm btn-neutral">Tambah</button>
                  </div>
              </div>
              <!-- Card stats -->
              <div class="row">
      ...
      <div class="modal fade" id="modal_pertanyaan_target" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <form method="post" id="form_kuesioner_pertanyaan">
                      <div class="modal-body">
                          <input type="hidden" name="id_list_kuesioner" id="id_list_kuesioner" value="<?php echo $id_list_kuesioner ?>">
      ...
      <div class="modal fade" id="modal_jawaban_konten" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg">
              <div class="modal-content">
                  ...
                  <form method="post" id="form_kuesioner_jawaban">
                      <div class="modal-body">
                  ...
                  <div class="card-body">
                      <div class="table-responsive">
                          <table id="tabel_kuesioner_jawaban" class="table table-hover table-sm display">
                              <thead>
                                  <tr>
                                      <th style="width: 5%;">No.</th>
      ...
      <script>
          $(document).ready(function() {
              ...
              var dataTable = $('#tabel_pertanyaan').DataTable({
                  ...
                  "order": [],
                  "ajax": {
                      "url": "<?php echo base_url(); ?>administrator/tabellistkuesionerPertanyaan",
                      "type": "POST",
                      "data": function(data) {
                          data.id_list_kuesioner = <?= $id_list_kuesioner; ?>
                      },
              ...
              // pertanyaan
              $('#tambah_pertanyaan_kuesioner').on('click', function() {
              ...
              //submit pertanyaan
              $(document).on('submit', '#form_kuesioner_pertanyaan', function(event) {
                  ...
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          $.ajax({
                              url: '<?php echo base_url(); ?>administrator/simpanlistkuesionerPertanyaan',
                              method: 'POST',
                              ...
                              success: function(data) {
                                  ...
                                  $('#form_kuesioner_pertanyaan')[0].reset();
                              }
                          });
                      }
                  })
              ...
              $(document).on("click", ".ubahstatus", function() {
                  ...
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          $.ajax({
                              url: '<?php echo base_url(); ?>administrator/ubahstatuskuesionerjawaban',
                              method: 'POST',
                              data: {
                                  id: id,
                                  status: status
              ...
              $(document).on('click', '.jawaban', function() {
                  ...
                  $('#form_kuesioner_jawaban')[0].reset();
                  var id_pertanyaan = $(this).attr('id');
                  //   console.log('j', id_pertanyaan);
                  dataTableJawaban = $('#tabel_kuesioner_jawaban').DataTable({
                      "serverSide": true,
                      "processing": true,
                      "showing": false,
                      "paging": false,
                      ...
                      "order": [],
                      "ajax": {
                          "url": "<?php echo base_url(); ?>administrator/tabelkuesionerJawaban",
                          "type": "POST",
                          "data": function(data) {
              ...
              $(document).on('click', '.jawaban_betul', function() {
                  ...
                  $.ajax({
                      url: "<?php echo base_url(); ?>administrator/getAllJawabankuesioner",
                      method: "POST",
                      dataType: 'JSON',
                      data: {
                  ...
                  $.ajax({
                      url: "<?php echo base_url(); ?>administrator/getPertanyaankuesioner",
                      method: "POST",
                      dataType: 'JSON',
                      data: {
                          id_pertanyaan: id_pertanyaan,
              ...
              $(document).on('submit', '#form_kuesioner_jawaban', function(event) {
                  event.preventDefault();
                  ...
                  if (jawaban == '') {
                      ...
                      $.ajax({
                          url: '<?php echo base_url(); ?>administrator/simpankuesionerJawaban',
                          method: 'POST',
                          data: {
                              jawaban: jawaban,
                              id_pertanyaan: id_pertanyaan,
              ...
              $(document).on('submit', '#form_jawaban_betul', function(event) {
                  ...
                  if (jawaban == '') {
                      ...
                      $.ajax({
                          url: '<?php echo base_url(); ?>administrator/simpanJawabanBetulkuesioner',
                          method: 'POST',
                          data: {
                              jawaban: jawaban,
                              id_pertanyaan: id_pertanyaan,
              ...
              $(document).on("click", ".statuspertanyaan", function() {
                  ...
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          $.ajax({
                              url: '<?php echo base_url(); ?>administrator/ubahstatuskuesionerpertanyaan',
                              method: 'POST',
                              data: {
                                  id: id,
                                  status: status
