      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          ...
          <div class="col-lg-6 col-5 text-right">
            <a href="<?php echo base_url(); ?>kuesioner" class="tambah_kuesioner btn btn-sm btn-neutral">Kembali</a>
          </div>
        </div>
        <!-- Card stats -->
        <div class="row">
  ...
  <div class="container-fluid mt--6 shadow-sm">
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-4 text-right">
                <button type="button" id="simpan_kuesioner" class="btn btn-sm btn-primary">Simpan</button>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form>
              <h6 class="heading-small text-muted mb-4">Kuesioner</h6>
              <div class="pl-lg-4">
                <div class="row">
                  <div class="col-lg-12">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      <label class="form-control-label" for="input-last-name">Tipe kuesioner</label>
                      <div class="input-group">
                        <select class="custom-select rounded-0" id="tipe" name="tipe">
    ...
    <!-- Modal Create User -->
    <div class="modal fade" id="modal_tambah_kuesioner" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <script>
      $(document).ready(function() {
        ...
        // simpan
        $('#simpan_kuesioner').on('click', function() {
          ...
          if (keterangan == '' || jenis == '' || tipe == '' || urutan == '' || urutan == '0' || description == '' || status == '') {
            ...
            $.ajax({
              url: '<?php echo base_url(); ?>administrator/simpankuesioner',
              method: 'POST',
              data: {
              ...
              success: function(data) {
                ...
                window.location.href = "<?php base_url(); ?>kuesioner/";
              }
            });
          }
