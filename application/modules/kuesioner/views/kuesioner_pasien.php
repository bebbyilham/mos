      ...
      <script>
          $(document).ready(function() {
              ...
              var dataTable = $('#tabel_kuesioner').DataTable({
                  ...
                  "order": [],
                  "ajax": {
                      "url": "<?php echo base_url(); ?>observasi/tabelkuesioner",
                      "type": "POST",
                      "data": function(data) {
              ...
              $.ajax({
                  url: "<?php echo base_url(); ?>observasi/getAllkuesioner",
                  method: "POST",
                  dataType: 'JSON',
                  data: {
              ...
              $(document).on('click', '.akses_kuesioner', function() {
                  var id = $(this).attr('id');
                  window.open('<?= base_url(); ?>observasi/akseskuesioner/' + id);
              });
              ...
              $(document).on('submit', '#form_akses_kuesioner', function(event) {
                  ...
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          $.ajax({
                              url: '<?php echo base_url(); ?>observasi/simpanAkseskuesioner',
                              method: 'POST',
              ...
              $(document).on("click", ".ubahstatus", function() {
                  ...
                  Swal.fire({
                      ...
                      if (result.isConfirmed) {
                          $.ajax({
                              url: '<?php echo base_url(); ?>observasi/ubahStatusAksesSelcontrol',
                              method: 'POST',
                              data: {
                                  id: id,
                                  status: status
