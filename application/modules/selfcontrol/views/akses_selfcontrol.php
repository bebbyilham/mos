              ...
              <div class="card shadow-sm">
                  ...
                  <div class="card-body">
                      <?php foreach ($edk as $e) : ?>
                          <h3>MATERI : <?php echo $e['metode']; ?></h3>
                          <hr>
                                  ...
                                  <?php foreach ($jaw as $j) :
                                    ...
                                    ?>
                                      ...
                                      <div class="custom-control custom-radio custom-control-inline">
                                          ...
                                          <input type="radio" <?= check_jawaban($pertanyaan_id, $id_akses_selfcontrol, $j['id_jawaban']); ?> id="customRadio<?php echo $j['id_jawaban']; ?>" id_jawaban="<?php echo $j['id_jawaban']; ?>" id_pertanyaan="<?php echo $j['id_pertanyaan']; ?>" id_akses_selfcontrol="<?php echo $id_akses_selfcontrol; ?>" id_selfcontrol="<?php echo $idk; ?>" id_user="<?php echo $user['id_user']; ?>" id_pasien="<?php echo $user['pasien_id']; ?>" name="customRadio<?php echo $j['id_pertanyaan'] ?>" class="custom-control-input pilih_jawaban">
